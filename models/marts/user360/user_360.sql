...
select
    ...
    coalesce(s.avg_session_time_last_30d, 0) as avg_session_time_last_30d,
    coalesce(s.total_session_time_last_30d, 0) as total_session_time_last_30d,

    -- rendimiento académico
    coalesce(p.avg_exam_score, 0) as avg_exam_score,
    coalesce(p.avg_attendance, 0) as avg_attendance,
